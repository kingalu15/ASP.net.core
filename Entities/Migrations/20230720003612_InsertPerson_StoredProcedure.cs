        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string sp_InsertPerson = @"
              CREATE PROCEDURE [dbo].[InsertPerson]
                (@PersonID uniqueidentifier,@PersonName nvarchar(50),@Email nvarchar(50),@DateOfBirth datetime,@Gender varchar(9),
                @CountryID uniqueidentifier,@Address varchar(200),@ReceiveNewsLetters bit) 
                  AS BEGIN
